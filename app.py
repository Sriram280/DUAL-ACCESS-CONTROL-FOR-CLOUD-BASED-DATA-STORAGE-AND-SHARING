...
def get_db():
    db = pymysql.connect(host='localhost',user='root',password='',port=3306,db='cloud')
    cursor=db.cursor()
    return db,cursor
...
def authorizationkey(s1=0,s2=''):
    ...
    sender_address = 'sriramkonduru0@gmail.com'
    sender_pass = 'npotxrvfugswrikz'
    receiver_address = s2
